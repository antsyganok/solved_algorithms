...
5 Функция range и итерируемые объекты

Поздравляю, вы добрались до 5-го раздела данного курса. Вы проделали огромную работу, и я горжусь вами.

Новый раздел мы начнем с изучения достаточно простой для понимания темы. Мы познакомимся со встроенной функцией range и узнаем, что такое «итерируемые объекты».
