...
Изучите внимательно все элементы списка,
у них имеется одинаковый набор ключей.
Ваша задача на основании списка persons отобрать информацию
о номерах телефона и сложить их в отдельный список phones.
...
'(471)195-7189', '001-098-434-5950x276', '+1-018-070-2288x18433',
'2930693269', '8643048473', '+1-583-428-7663', '714-879-5250']
"""
...
phones = [*map(lambda x: x['phone'], persons)]
print(phones)
